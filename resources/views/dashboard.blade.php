...
<div class="row">
    <div class="col-12">
        <h1 class="h3 mb-4">Dashboard - Sistema de Ventas</h1>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-2 mb-3">
        <a href="{{ route('sales.create') }}" class="btn btn-outline-info w-100 h-100 d-flex flex-column justify-content-center align-items-center py-4">
    ...
    <div class="col-md-2 mb-3">
        <a href="{{ route('products.index') }}" class="btn btn-outline-secondary w-100 h-100 d-flex flex-column justify-content-center align-items-center py-4">
